...
function wrapSelect() {
	jQuery('select').each(function() {
		...
		$select.addClass('empty choice').wrap('<div class="form-group select-group"></div>').after('<i class="fa fa-angle-down theme_button color1 no_bg_button" aria-hidden="true"></i>');
	})
}
